...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String str = "http://www.920yy.com/";
        Context context=Main4Activity.this;
        ...
        dialog = ProgressDialog.show(Main4Activity.this, null, "正在加载中，请稍后···");
    ...
    private class webChromClient extends WebChromeClient {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg){
            ...
            i.setType("image/*");
            Main4Activity.this.startActivityForResult(
    ...
    private class webClient extends WebViewClient{
        ...
        public void onReceivedError(WebView view,int errorCode, String description,String failingUrl) {
            ...
            // guo add  
            Toast.makeText(Main4Activity.this,"网页加载出错！",Toast.LENGTH_LONG).show();
