...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = ProgressDialog.show(Main3Activity.this, null, "正在加载中，请稍后···");
    ...
    private class webChromClient extends WebChromeClient {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg){
            ...
            i.setType("image/*");
            Main3Activity.this.startActivityForResult(
    ...
    private class webClient extends WebViewClient{
        ...
        public void onReceivedError(WebView view,int errorCode, String description,String failingUrl) {
            ...
            // guo add  
            Toast.makeText(Main3Activity.this,"网页加载出错！", Toast.LENGTH_LONG).show();
